...
while "exit" not in EmpInput1:
    ...
    if first_command=="create" :
        ...
        index=[]
        number_of_index=[]
        name_table=module2.create_table(EmpInput, result, index,number_of_index)
        ...
        if tables:
            ...
            try:
                if check_if_name_is_right==0:
                    ...
                    try:
                        name_table= module3.Table(name_table, result, index,number_of_index)
        ...
        if ("*" in EmpInput1):
            if ("where" in EmpInput1):
                result1=[]
                name_of_insert=module2.select_all_where(EmpInput, result1)
                check_if_name_is_right=-1
                for elem in tables:
                            ...
                            try:
                                if number ==0:
                                    ...
                                    try:
                                        ...
                                        elem.show_col_where(indexes, number-1,result1[size_res-2], result1[size_res-1],right_rows)
                            ...
                            try:
                                ...
                                if number2==0:
                                    ...
                                    try:
                                        ...
                                        columns=elem.get_table()
                                        elem.get_col_name(column_names)
                                        elem.show_col_where_two_col(indexes, number1-1, number2-1, result1[size_res-2],right_rows)
                                        print(f"this is {elem.get_name()} table")
                                        beatiful_print(column_names,columns,indexes, right_rows)
                                    except :
                                        print("something vemt wrong")
                ...
                name_of_insert=module2.select_all(EmpInput)
                check_if_name_is_right=-1
                for elem in tables:
                    if elem.get_name()==name_of_insert:
                        check_if_name_is_right=1
            ...
            result1=[]
            name_of_insert=module2.select_where(EmpInput, result1)
            check_if_name_is_right=-1
            for elem in tables:
                if elem.get_name()==name_of_insert:
                    check_if_name_is_right=1
                        ...
                        try:
                            ...
                            if number ==0:
                                ...
                                try:
                                    ...
                                    columns=elem.get_table()
                                    elem.get_col_name(column_names)
                                    elem.show_col_where(indexes, number-1,result1[size_res-2], result1[size_res-1],right_arr_rows)
                                    print(f"this is {elem.get_name()} table")
                    ...
                    try:
                        ...
                        #delete_dupes(indexes)
                                    ...
                                    try:
                                        ...
                                        columns=elem.get_table()
                                        elem.get_col_name(column_names)
                                        elem.show_col_where_two_col(indexes, number1-1, number2-1, result1[size_res-1],right_rows)
                                        print(f"this is {elem.get_name()} table")
                                        beatiful_print(column_names, columns,indexes, right_rows)
                                    except:
                                        print("smth went wrong")
            ...
            result1=[]
            name_of_insert=module2.select_columns(EmpInput, result1)
            check_if_name_is_right=-1
            for elem in tables:
                if elem.get_name()==name_of_insert:
                    name_of_insert= elem.get_name()
        ...
        if ("where" in EmpInput1):
            ...
            result1=[]
            name_of_insert=module2.delete(EmpInput)
            check_if_name_is_right=-1
            for elem in tables:
                if elem.get_name()==name_of_insert:
                    name_of_insert= elem.get_name()
